// Thread to share generated blocks and collect finalization proofs from the quorum
// Here we collect AFP - aggregated finalization proof for each block
// We take the blocks generated by block_generation.go
package threads
		...
		if PROOFS_GRABBER.EpochId != epochSnapshot.Id {
			...
			if rawGrabber, err := databases.FINALIZATION_VOTING_STATS.Get(dbKey, nil); err == nil {
				...
				PROOFS_GRABBER = ProofsGrabber{
					...
					AcceptedHash: constants.ZeroHash,
				}
